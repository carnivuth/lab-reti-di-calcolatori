...
#ifndef _ESERCITAZIONE9_H_RPCGEN
#define _ESERCITAZIONE9_H_RPCGEN
...
typedef struct voidInput voidInput;

struct voidOutput {
	int a;
};
typedef struct voidOutput voidOutput;
...
extern  bool_t xdr_voidInput (XDR *, voidInput*);
extern  bool_t xdr_voidOutput (XDR *, voidOutput*);
...
extern bool_t xdr_voidInput ();
extern bool_t xdr_voidOutput ();
...
#endif /* !_ESERCITAZIONE9_H_RPCGEN */
