...
public class ClientProposta {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sock = new DatagramSocket(1900,addr);
			...
			buff = packet.getData();
			String portaRowSwap = diStream.readUTF(); //ipotesi aaaa.bbbb.cccc.dddd:port
			...
			InetAddress rsAddr = InetAddress.getByName(portaRowSwap);
